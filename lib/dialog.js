...
export default class Dialog {
  constructor({ initialPath, iconClass, prompt } = {}) {
    ...
    // Add options
    this.element.appendChild(radioGroup('Select component type', 'type', ['class', 'functional', 'react-native']));
    this.element.appendChild(radioGroup('Select style syntax', 'styles', ['scss', 'less', 'css', 'no styles']));
